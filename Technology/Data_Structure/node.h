...
private:
    ...
    void insert_data_into_this_node(string senderID, string receiverID, string transactionID, string transactionType, string transactionDate, double amount);
...
public:
    ...
    string get_hash_value_of_this_node();
    ~node();
};
